...
namespace University.Infrastructure.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UniversityIndex = table.Column<string>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Courses_Faculties_DepartmentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Offices_Professors_ProfessorId",
                        column: x => x.ProfessorId,
                        principalTable: "Professors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    table.PrimaryKey(
                        "PK_CoursePrerequisites",
                        x => new { x.CourseId, x.PrerequisiteId }
                    );
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Professors_UniversityIndex",
                table: "Professors",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Students_UniversityIndex",
                table: "Students",
                column: "UniversityIndex",
                unique: true
            );
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropTable(name: "IndexCounters");
