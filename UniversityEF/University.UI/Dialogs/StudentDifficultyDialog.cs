...
public class StudentDifficultyDialog : Dialog
{
    ...
    public StudentDifficultyDialog(IServiceProvider serviceProvider)
        : base("Student with Hardest Schedule", 70, 16)
    {
    ...
    private void InitializeComponents()
    {
        var infoLabel = new Label(
            "Click 'Run Query' to find the student with the hardest schedule:"
        )
        {
            X = 2,
            Y = 1,
    ...
    private async void OnRunClicked()
    {
        try
        {
            ...
            {
                _resultLabel.Text = "No students found.";
            }
        }
        catch (Exception ex)
        {
